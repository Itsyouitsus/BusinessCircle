  ...
  return (
    <div style={{ height: '100vh', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
        {/* Fake skeleton cards — no text labels */}
        ...
        <div style={{
          ...
          background: 'linear-gradient(to bottom, rgba(245,196,0,0) 0%, rgba(245,196,0,0.85) 25%, rgba(245,196,0,1) 45%)',
          display: 'flex', alignItems: 'center', justifyContent: 'center'
        }}>
          <div style={{ textAlign: 'center', maxWidth: 480, padding: '0 24px', marginTop: -40 }}>
            <div style={{
